...
public class Gui extends AbstractGuiContainer<Gui, NativeGui> {
	 ...
	 * {@link #onEvent(ComponentEvent.ComponentEventListener, Class, Side)} specifying on which
	...
	protected void dispatchNetworkEvent(ComponentEvent.SidedComponentEvent event, GuiComponent<?, ?> sender) {
	 ...
	 * {@link GuiEvent.BindEvent} in order to supply it to {@link Slot}.
	 *
