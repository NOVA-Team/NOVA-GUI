...
public class FlowLayout extends AbstractGuiLayout<Constraints.FlowLayoutConstraints> {
	...
	public FlowLayout(Anchor anchor) {
		super(Constraints.FlowLayoutConstraints.class);
	...
	@Override
	protected void addImpl(GuiComponent<?, ?> component, AbstractGuiContainer<?, ?> parent, Constraints.FlowLayoutConstraints constraints) {
